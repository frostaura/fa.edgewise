...
describe('adherenceGrade', () => {
  it('maps scores onto the A–F ramp', () => {
    ...
    expect(adherenceGrade(75)).toBe('B')
    expect(adherenceGrade(74)).toBe('C')
    expect(adherenceGrade(60)).toBe('C')
    expect(adherenceGrade(59)).toBe('D')
    expect(adherenceGrade(40)).toBe('D')
    expect(adherenceGrade(39)).toBe('F')
